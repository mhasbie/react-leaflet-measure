					...
					<div className="card bg-dark text-white">
						<div className="card-body">
							<pre><code className="text-white">
								...
								import MeasureControl from 'react-leaflet-measure';<br />
								<br />
								const measureOptions = &#123;<br />
								&nbsp;&nbsp;&nbsp;&nbsp;position: 'topright',<br />
								&nbsp;&nbsp;&nbsp;&nbsp;primaryLengthUnit: 'meters',<br />
								&nbsp;&nbsp;&nbsp;&nbsp;secondaryLengthUnit: 'kilometers',<br />
								&nbsp;&nbsp;&nbsp;&nbsp;primaryAreaUnit: 'sqmeters',<br />
								&nbsp;&nbsp;&nbsp;&nbsp;secondaryAreaUnit: 'acres',<br />
								&nbsp;&nbsp;&nbsp;&nbsp;activeColor: '#db4a29',<br />
								&nbsp;&nbsp;&nbsp;&nbsp;completedColor: '#9b2d14',<br />
								&nbsp;&nbsp;&nbsp;&nbsp;captureZIndex: 10000,<br />
								&nbsp;&nbsp;&nbsp;&nbsp;onMeasureStart: (e) =&gt; console.log('Measurement started:', e),<br />
								&nbsp;&nbsp;&nbsp;&nbsp;onMeasureFinish: (e) =&gt; console.log('Measurement finished:', e),<br />
								&#125;;<br />
								<br />
								...
								&nbsp;&nbsp;&nbsp;&nbsp;&lt;MeasureControl &#123;...measureOptions&#125; /&gt;<br />
								&lt;/MapContainer&gt;
							</code></pre>
						</div>
					</div>
